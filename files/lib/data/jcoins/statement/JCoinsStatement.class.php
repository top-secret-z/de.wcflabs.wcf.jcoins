...
class JCoinsStatement extends DatabaseObject
{
    ...
    protected function loadObject()
    {
        if ($this->objectID != null) {
            ...
            } elseif ($this->objectClassName !== null) {
            ...
            if ($this->object instanceof Conversation && !$this->object->conversationID) {
                $this->object = null;
            }
            if ($this->object instanceof ConversationMessage && !$this->object->messageID) {
                $this->object = null;
            }
            if ($this->object instanceof Comment && !$this->object->commentID) {
                $this->object = null;
            }
            if ($this->object instanceof CommentResponse && !$this->object->responseID) {
                $this->object = null;
            }
            if ($this->object instanceof Trophy && !$this->object->trophyID) {
                $this->object = null;
            }
        }
    }
